...
import InteractionGreetingStatic from "./InteractionGreetingStatic"
import AvatarDashboard from "./AvatarDashboard"

function AlienDialogueStatic() {
  return (
    <>
      ...
      <div className="screenContentContainer0">
        <div className="meowmersWrapper">
          <div divstyle="flex-basis:200px" className="meowmersStatic"></div>
        </div>
...
export default AlienDialogueStatic
